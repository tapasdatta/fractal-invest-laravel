    ...
    <nav class="flex h-full min-h-0 flex-col">
        <div class="flex flex-col border-b border-zinc-950/5 p-4 dark:border-white/5 [&amp;>[data-slot=section]+[data-slot=section]]:mt-2.5">
            <span class="relative">
                ...
                >
                    ...
                    <span data-slot="avatar" class="inline-grid shrink-0 align-middle [--avatar-radius:20%] *:col-start-1 *:row-start-1 outline -outline-offset-1 outline-black/10 dark:outline-white/10 rounded-full *:rounded-full">
                        <img class="size-full" src="{{ asset('images/teams/catalyst.svg') }}" alt="logo" />
                    </span>
                    <span class="truncate">Catalyst</span>
        ...
        <div class="flex flex-1 flex-col overflow-y-auto p-4 [&amp;>[data-slot=section]+[data-slot=section]]:mt-8">
            <div data-slot="section" class="flex flex-col gap-0.5">
                <span class="relative">
                    <span class="absolute inset-y-2 -left-4 w-0.5 rounded-full bg-zinc-950 dark:bg-white" style="transform: none; transform-origin: 50% 50% 0px; opacity: 1;"></span>
                    <a
            ...
            <div data-slot="section" class="max-lg:hidden flex flex-col gap-0.5">
                ...
                <span class="relative">
                    <a
                        ...
                        href="/events/1000"
                    >
                        <span class="absolute top-1/2 left-1/2 size-[max(100%,2.75rem)] -translate-x-1/2 -translate-y-1/2 [@media(pointer:fine)]:hidden" aria-hidden="true"></span>Bear Hug: Live in Concert
                    </a>
                </span>
                <span class="relative">
                    <a
                        ...
                        href="/events/1001"
                    >
                        <span class="absolute top-1/2 left-1/2 size-[max(100%,2.75rem)] -translate-x-1/2 -translate-y-1/2 [@media(pointer:fine)]:hidden" aria-hidden="true"></span>Six Fingers — DJ Set
                    </a>
                </span>
                <span class="relative">
                    <a
                        ...
                        href="/events/1002"
                    >
                        <span class="absolute top-1/2 left-1/2 size-[max(100%,2.75rem)] -translate-x-1/2 -translate-y-1/2 [@media(pointer:fine)]:hidden" aria-hidden="true"></span>We All Look The Same
                    </a>
                </span>
                <span class="relative">
                    <a
                        ...
                        href="/events/1003"
                    >
                        <span class="absolute top-1/2 left-1/2 size-[max(100%,2.75rem)] -translate-x-1/2 -translate-y-1/2 [@media(pointer:fine)]:hidden" aria-hidden="true"></span>Viking People
                    </a>
                </span>
            </div>
            ...
            <span class="relative">
                ...
                >
                    ...
                    <span class="flex min-w-0 items-center gap-3">
                        ...
                        >
                            <img class="size-full" src="{{ asset('images/users/erica.jpg') }}" alt="" />
                        </span>
                        <span class="min-w-0">
                            <span class="block truncate text-sm/5 font-medium text-zinc-950 dark:text-white">erica@example.com</span>
                            <livewire:logout />
                        </span>
                    </span>
                </div>
            ...
            <div class="flex items-center gap-3">
                <span class="relative">
                    ...
                    >
                        ...
                        <span
                            data-slot="avatar"
                            class="inline-grid shrink-0 align-middle [--avatar-radius:20%] *:col-start-1 *:row-start-1 outline -outline-offset-1 outline-black/10 dark:outline-white/10 rounded-(--avatar-radius) *:rounded-(--avatar-radius)"
                        >
                            <img class="size-full" src="{{ asset('images/users/erica.jpg') }}" alt="" />
                        </span>
                    </button>
